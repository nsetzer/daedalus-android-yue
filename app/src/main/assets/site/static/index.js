...
api.requests=(function(){
    ...
    return{'get_json':get_json,'get_text':get_text,'post':post,'post_json':post_json,
          'put_json':put_json};
  })();
Object.assign(api,(function(requests,daedalus){
      "use strict";
      ...
      const[authenticate,env,fsGetPath,fsGetPathContent,fsGetPathContentUrl,fsGetPublicPathUrl,
          ...
          function authenticate(email,password){
            ...
            return api.requests.post_json(url,{'email':email,'password':password},
                          {'timeout':5000});
          };
          function validate_token(token){
            const url=env.baseUrl+'/api/user/token';
            return api.requests.post_json(url,{'token':token},{'timeout':5000});
          };
          function fsGetRoots(){
          ...
          function fsSearch(root,path,terms,page,limit){
            const params=daedalus.util.serializeParameters({'path':path,'terms':terms,
          ...
          function fsNoteList(root,base){
            const params=daedalus.util.serializeParameters({'root':root,'base':base});
          ...
          function queueCreate(query,limit=50){
            const params=daedalus.util.serializeParameters({'query':query,'limit':limit});
          ...
          function librarySearchForest(query,showBanished=false){
            const params=daedalus.util.serializeParameters({'query':query,'showBanished':showBanished});
          ...
          function userDoc(hostname){
            const params=daedalus.util.serializeParameters({'hostname':hostname});
          ...
          function radioVideoInfo(videoId){
            const params=daedalus.util.serializeParameters({'videoId':videoId});
          ...
          function radioStationEnable(station,enable){
            const params=daedalus.util.serializeParameters({'enable':enable});
          ...
          function radioStationRemoveTrack(station,uid){
            const url=env.baseUrl+daedalus.util.joinpath('/api/radio/station',station,
                          "remove_track");
            const cfg=getAuthConfig();
            return api.requests.post_json(url,{'uid':uid},cfg);
          };
          function radioStationSearch(station,source,query){
            const params=daedalus.util.serializeParameters({'source':source,'query':query});
          ...
          function radioStationRelated(station,source,sid){
            const params=daedalus.util.serializeParameters({'source':source,'sid':sid});
          ...
          function radioStationUpdates(station,updateId){
            const params=daedalus.util.serializeParameters({'updateId':updateId});
          ...
          function radioStationVote(station,uid,magnitude){
            const url=env.baseUrl+daedalus.util.joinpath('/api/radio/station',station,
                          "vote");
            const cfg=getAuthConfig();
            return api.requests.post_json(url,{'uid':uid,'magnitude':magnitude},cfg);
      ...
      return{'authenticate':authenticate,'clearPublicToken':clearPublicToken,'clearUserToken':clearUserToken,
              'env':env,'fsGetPath':fsGetPath,'fsGetPathContent':fsGetPathContent,'fsGetPathContentUrl':fsGetPathContentUrl,
              'fsGetPublicPathUrl':fsGetPublicPathUrl,'fsGetRoots':fsGetRoots,'fsNoteCreate':fsNoteCreate,
              'fsNoteGetContent':fsNoteGetContent,'fsNoteList':fsNoteList,'fsNoteSetContent':fsNoteSetContent,
              'fsPathPreviewUrl':fsPathPreviewUrl,'fsPathUrl':fsPathUrl,'fsPublicUriGenerate':fsPublicUriGenerate,
              'fsPublicUriInfo':fsPublicUriInfo,'fsPublicUriRevoke':fsPublicUriRevoke,'fsSearch':fsSearch,
              'fsUploadFile':fsUploadFile,'getAuthConfig':getAuthConfig,'getAuthToken':getAuthToken,
              'getIngredients':getIngredients,'getPublicConfig':getPublicConfig,'getPublictoken':getPublictoken,
              'getUsertoken':getUsertoken,'hasUsertoken':hasUsertoken,'libraryDomainInfo':libraryDomainInfo,
              'librarySearchForest':librarySearchForest,'librarySong':librarySong,'librarySongAudioUrl':librarySongAudioUrl,
              'multiSort':multiSort,'openTab':openTab,'queueCreate':queueCreate,'queueGetQueue':queueGetQueue,
              'queuePopulate':queuePopulate,'queueSetQueue':queueSetQueue,'radioPublicStationAddTrack':radioPublicStationAddTrack,
              'radioPublicStationPreviousTracks':radioPublicStationPreviousTracks,'radioPublicStationRelated':radioPublicStationRelated,
              'radioPublicStationSearch':radioPublicStationSearch,'radioPublicStationTracks':radioPublicStationTracks,
              'radioPublicStationUpdates':radioPublicStationUpdates,'radioPublicStationVote':radioPublicStationVote,
              'radioStationAddTrack':radioStationAddTrack,'radioStationCurrentTrack':radioStationCurrentTrack,
              'radioStationEnable':radioStationEnable,'radioStationInfo':radioStationInfo,
              'radioStationList':radioStationList,'radioStationNextTrack':radioStationNextTrack,
              'radioStationPreviousTracks':radioStationPreviousTracks,'radioStationRelated':radioStationRelated,
              'radioStationRemoveTrack':radioStationRemoveTrack,'radioStationResetTracks':radioStationResetTracks,
              'radioStationSave':radioStationSave,'radioStationSearch':radioStationSearch,
              'radioStationShutdown':radioStationShutdown,'radioStationTracks':radioStationTracks,
              'radioStationUpdates':radioStationUpdates,'radioStationUrl':radioStationUrl,
              'radioStationVote':radioStationVote,'radioVideoInfo':radioVideoInfo,'recipeGetContent':recipeGetContent,
              'recipeGetRecipes':recipeGetRecipes,'setPublictoken':setPublictoken,'setUsertoken':setUsertoken,
              'shuffle':shuffle,'sortTracks':sortTracks,'track_shuffle':track_shuffle,'userDoc':userDoc,
              'validate_token':validate_token};
    })(api.requests,daedalus));
...
components=(function(api,daedalus,resources){
    ...
    const[CheckBoxElement]=(function(){
        ...
        class CheckBoxElement extends SvgElement {
          constructor(callback,initialCheckState){
            ...
            this.attrs={'callback':callback,'checkState':initialCheckState,'initialCheckState':initialCheckState};
    ...
    const[NavMenu]=(function(){
        const style={'navMenuShadow':'dcs-2cc64f69-0','navMenuShadowHide':'dcs-2cc64f69-1',
                  ...
                  'navMenuActionContainer':'dcs-2cc64f69-5','navMenuHide':'dcs-2cc64f69-6',
    ...
    const[TreeItem,TreeView]=(function(){
        const style={'treeView':'dcs-11073d64-0','treeItem':'dcs-11073d64-1','treeItemObjectContainer':'dcs-11073d64-2',
                  'treeItemChildContainer':'dcs-11073d64-3','treeItem0':'dcs-11073d64-4',
                  'treeItemN':'dcs-11073d64-5','listItemMid':'dcs-11073d64-6','listItemEnd':'dcs-11073d64-7',
                  'listItemSelected':'dcs-11073d64-8','treeFooter':'dcs-11073d64-9'};
        ;
        ...
        class TreeItem extends DomElement {
          constructor(parent,depth,title,obj,selectMode=1,selected=UNSELECTED){
            ...
            this.attrs={'parent':parent,'depth':depth,'title':title,'obj':obj,'children':null,
                          'selected':selected,'selectMode':selectMode,'chk':null};
    ...
    const[MoreMenu]=(function(){
        const style={'moreMenuShadow':'dcs-131ebe5c-0','moreMenu':'dcs-131ebe5c-1',
                  'moreMenuShow':'dcs-131ebe5c-2','moreMenuHide':'dcs-131ebe5c-3','moreMenuButton':'dcs-131ebe5c-4',
                  'moreMenuSection':'dcs-131ebe5c-5','moreMenuSectionHeader':'dcs-131ebe5c-6',
                  'moreMenuSectionText':'dcs-131ebe5c-7'};
        ;
        ;
        class MoreMenuButton extends DomElement {
          constructor(text,callback){
            super("div",{'className':[style.moreMenuButton],'onClick':callback},[
        ...
        class NavFooter extends DomElement {
          constructor(){
            ...
            this.attrs={'div':new DomElement("div",{'className':style.headerDiv},
                              ...
                              []),'toolbarInner':new DomElement("div",{'className':style.toolbarFooterInnerV1},
                              [])};
            this.appendChild(this.attrs.div);
            this.attrs.div.appendChild(this.attrs.toolbar);
            this.attrs.toolbar.appendChild(this.attrs.toolbarInner);
    ...
    const[ProgressBar]=(function(){
        ...
        class ProgressBar extends DomElement {
          constructor(callback){
            ...
            this.attrs={'callback':callback,'pressed':false,'pos':0,'tpos':0,'startx':0,
                          'track':this.appendChild(new ProgressBarTrack()),'btn':this.appendChild(
                              new ProgressBarButton())};
          }
        ...
        class ErrorDrawer extends DomElement {
          constructor(icon){
            ...
            this.attrs={'div':new DomElement("div",{'className':style.headerDiv},
                              ...
                              {'className':style.message},[]),'divButton':new DomElement("div",
          ...
          appendError(title,message){
            this.attrs.errors.push({'title':title,'message':message});
    ...
    const[QrCodeElement]=(function(){
        ...
        let QRMaskPattern={'PATTERN000':0,'PATTERN001':1,'PATTERN010':2,'PATTERN011':3,
    ...
    return{'CheckBoxElement':CheckBoxElement,'ErrorDrawer':ErrorDrawer,'HSpacer':HSpacer,
          'HStretch':HStretch,'MiddleText':MiddleText,'MiddleTextLink':MiddleTextLink,
          'MoreMenu':MoreMenu,'NavFooter':NavFooter,'NavHeader':NavHeader,'NavMenu':NavMenu,
          'ProgressBar':ProgressBar,'QrCodeElement':QrCodeElement,'Refresh':Refresh,'Slider':Slider,
          'SvgButtonElement':SvgButtonElement,'SvgElement':SvgElement,'SwipeHandler':SwipeHandler,
          'TreeItem':TreeItem,'TreeView':TreeView,'VSpacer':VSpacer};
...
router=(function(api,daedalus){
    ...
    return{'AppRouter':AppRouter,'navigate':navigate,'route_urls':route_urls,'routes':routes};
...
pages.audio=(function(api,daedalus){
    ...
    const[AudioDevice,NativeDeviceImpl,QDeviceImpl,RemoteDeviceImpl]=(function(){
        ...
        function mapSongToObj(song){
          return{'url':api.librarySongAudioUrl(song.id),'artist':song.artist,'album':song.album,
                      'title':song.title,'length':song.length,'play_count':song.play_count,
                      'year':song.year,'file_path':song.file_path,'spk':song.spk,'id':song.id};
          ...
          queueRemoveIndex(index){
            if(index>=0&&index<this.queue.length){
              ...
              if(this.current_index>=this.queue.length){
                ...
                this.pause();
                this._sendEvent('handleAudioSongChanged',{...this.queue[index],'index':index});
    ...
    const[BrownNoiseContext,NoiseContext,OceanNoiseContext,PinkNoiseContext,WhiteNoiseContext]=(
          function(){
        const EasingFunctions={'linear':t=>t,'easeInQuad':t=>t*t,'easeOutQuad':t=>t*(
                      2-t),'easeInOutQuad':t=>t<.5?2*t*t:-1+(4-2*t)*t,'easeInCubic':t=>t*t*t,
                  'easeOutCubic':t=>(--t)*t*t+1,'easeInOutCubic':t=>t<.5?4*t*t*t:(t-1)*(2*t-2)*(
                      2*t-2)+1,'easeInQuart':t=>t*t*t*t,'easeOutQuart':t=>1-(--t)*t*t*t,'easeInOutQuart':t=>t<.5?8*t*t*t*t:1-8*(
                      --t)*t*t*t,'easeInQuint':t=>t*t*t*t*t,'easeOutQuint':t=>1+(--t)*t*t*t*t,
    ...
    return{'AudioDevice':AudioDevice,'BrownNoiseContext':BrownNoiseContext,'NativeDeviceImpl':NativeDeviceImpl,
          'NoiseContext':NoiseContext,'OceanNoiseContext':OceanNoiseContext,'PinkNoiseContext':PinkNoiseContext,
